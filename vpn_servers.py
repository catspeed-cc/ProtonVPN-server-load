...
def find_a_server_in(location):
    ...
    the_hostname = server_hostnames[filtered_list[index_lowest]]
    ...
    if draw == 1:
        the_server_2 = server_names[filtered_list[index_lowest_2]]
        the_hostname_2 = server_hostnames[filtered_list[index_lowest_2]]
